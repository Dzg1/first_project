 ...
 */
final class Version20221229081208 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE director ADD CONSTRAINT FK_1E90D3F07A8D2620 FOREIGN KEY (composer_id) REFERENCES composer (id)');
